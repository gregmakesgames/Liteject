...
namespace Liteject.Internal
{
    public static class Assert
    {
        ...
        public static void Warn(bool condition)
        {
            if (!condition)
            {
                Liteject.Log.Warn("Warning!  See call stack");
            }
        }
        ...
        public static void Warn(bool condition, Func<string> messageGenerator)
        {
            if (!condition)
            {
                Liteject.Log.Warn("Warning Assert hit! " + messageGenerator());
            }
        }
        ...
        public static void Warn(bool condition, string message)
        {
            if (!condition)
            {
                Liteject.Log.Warn("Warning Assert hit! " + message);
            }
        }
